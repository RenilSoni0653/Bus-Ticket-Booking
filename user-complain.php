...
if(isset($_POST['update']))
{
	...
	$query="insert into complaint(pid,rid,value,status) values('$pid','$rid','$value','$status')";
	...
	{
		echo"<script>alert('Complaint not submitted successfully');</script>";
	}
}
?>
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title"><?php echo $row->fname;?>'s&nbsp;Complaint </h2>
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label">Compaints : </label>
											
												<div class="col-sm-8">
												
													<select name="value1" class="form-control" required="required">
										
														<option>----- Choose complaint from below options -----</option>
														<option value="Bus is not clean">Bus is not clean</option>
														<option value="Seat quality is not good">Seat quality is not good</option>
														<option value="Driver's driving is not good">Driver's driving is not good</option>
										...
										<div class="form-group">
													<label class="col-sm-2 control-label">Other Compaints : </label>
													<div class="col-sm-8">
													<textarea name="value2" placeholder="Other complaints" rows="5" cols="105"></textarea>
													</div>
