...
if(isset($_POST['submit']))
{
	...
	$query="update routes set rid=?,bno=?,bname=?,source=?,destination=?,price=?,d_arrival_time=?,status=? where rid=?";
	$stmt = $mysqli->prepare($query);
	$rc=$stmt->bind_param('sssssisis',$rid,$bno,$bname,$source,$dest,$price,$dept,$status,$rid);
	$stmt->execute();
	...
	{
		echo"<script>alert('Bus has Not been updated successfully');</script>";
	}
}
...
<body>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							...
							$rid=$_GET['rid'];
							$qu=mysqli_query($mysqli,"select * from routes where rid='$rid'");
	...
	<input type="text" class="form-control" name="bno" value="<?php echo $row['bno']; ?>" id="cns" readonly>
		...
		<div class="col-sm-8">
	<input type="text" class="form-control" name="rid" value="<?php echo $row['rid']; ?>" readonly>
						 </div>
	...
	<input type="text" class="form-control" name="source" value="<?php echo $row['source']; ?>" id="cns" readonly>
		...
		<div class="col-sm-8">
	<input type="text" class="form-control" name="rname" value="<?php echo $row['destination']; ?>">
						 </div>
						</div>
	...
	<input type="text" class="form-control" name="price" value="<?php echo $row['price']; ?>">
		...
		<div class="col-sm-8">
	<input type="number" min="0" max="1" class="form-control" name="status" value="<?php echo $row['status']; ?>" id="sts">
						 </div>
						</div>
							<?php } ?>
