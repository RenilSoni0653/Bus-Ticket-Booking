...
if(isset($_POST['submit']))
{
	...
	$qu = mysqli_query($mysqli,"select * from admin where email='$emailid'");
	...
	{
		$query=mysqli_query($mysqli,"insert into admin(fname,mname,lname,username,gender,phone,email,password,status) values('$fname','$mname','$lname','$username','$gender','$contactno','$emailid','$password','$status')");
...
<div class="col-sm-8">
<input type="text" name="mname" id="mname" pattern="[A-Za-z]{0,20}" title="Enter letters only" class="form-control">
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="lname" id="lname" pattern="[A-Za-z]{0,20}" title="Enter letters only" class="form-control" required="required">
</div>
</div>
