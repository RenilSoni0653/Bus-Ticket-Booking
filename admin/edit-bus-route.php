...
<body>
	...
	<div class="ts-main-content">
		...
		<br>			
					...
					<div class="col-sm-8">
					<input type="text"  name="rid" value="<?php echo $row['rid']; ?>" class="form-control" readonly> </div>
					</div>
	...
	<input type="text" class="form-control" name="source" value="<?php echo $row['source']; ?>" id="cns" readonly>
		...
		<div class="col-sm-8">
	<input type="text" class="form-control" name="rname" pattern='[A-Za-z]{3,10}' title='Enter letters only' required>
						 </div>
						</div>
