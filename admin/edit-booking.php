...
$query="update buses set bname=?,bno=?,total_seat=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssi',$bname,$bno,$seat,$id);
$stmt->execute();
...
<div class="form-group">
									...
									<div class="col-sm-8">
									<input type="text" class="form-control" name="seat" value="<?php echo $row->total_seat;?>" >
												</div>
											</div>
...
<?php } ?>
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="submit" value="Update Booking">
												</div>
											</div>
