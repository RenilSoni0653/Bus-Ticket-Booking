...
{
	$id=intval($_GET['del']);
	$adn="delete from compare where id=?";
...
$r=mysqli_query($mysqli,"select * from compare");
$routes=mysqli_fetch_array($r);
$route_bno=$routes['bno'];
$date=date('y-m-d');

$query1="select b.bno,b.source,b.destination,b.arrival,b.departure,b.book_date,r.destination from book b,compare r where b.bno='$route_bno' and (b.source='$source' and b.book_date='$date')";
