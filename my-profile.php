...
$query="update  user_reg set fname=?,mname=?,lname=?,gender=?,phone=?,updationDate=? where id=?";
...
<div class="col-sm-8">
<input type="text" name="lname" id="lname"  class="form-control" value="<?php echo $row->lname;?>" required="required">
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="contact" id="contact"  class="form-control" maxlength="10" value="<?php echo $row->phone;?>" required="required">
</div>
</div>
